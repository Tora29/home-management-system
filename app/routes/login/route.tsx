  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        />
        <div
          className="absolute w-20 h-20 rounded-full bg-[#00f0ff] blur-[50px] cyberpunk-flicker-4"
        ...
        />
        <div
          className="absolute w-16 h-16 rounded-full bg-[#ff00ff] blur-[40px] cyberpunk-flicker-6"
        ...
        <div className="relative p-8 pt-12">
          ...
          {alert && (
            ...
            >
              ...
              <div className="absolute top-4 right-4">
                <div
                  className={`w-2 h-2 rounded-full ${alert.type === "success" ? "bg-[#00ff66]" : "bg-[#ff0044]"} animate-pulse`}
                />
              </div>
          ...
          <div className="mt-8 space-y-4 text-center">
            ...
            <div className="flex items-center gap-4">
              <div className="flex-1 h-[1px] bg-gradient-to-r from-transparent to-[#2a2a44]" />
              <span className="text-[10px] font-mono text-[#606080] tracking-widest">
                OR
              </span>
              <div className="flex-1 h-[1px] bg-gradient-to-l from-transparent to-[#2a2a44]" />
            </div>

            {/* 新規登録リンク */}
            <p className="text-sm font-mono text-[#606080]">
              NO ACCOUNT?{" "}
              <Link
                to="/register"
                className="text-[#ff00ff] hover:text-[#ff66ff] transition-colors"
              >
                REGISTER
              </Link>
            </p>
      ...
      <div className="mt-8 flex items-center gap-3 relative z-10">
        <div className="flex gap-1">
          ...
          <div
            className="w-2 h-1 rounded-full bg-[#00f0ff]/50"
            style={{ animationDelay: "0.3s" }}
          />
          <div
            className="w-1 h-1 rounded-full bg-[#00f0ff]/30"
        ...
        <div className="flex gap-1">
          <div
            className="w-1 h-1 rounded-full bg-[#ff00ff]/30"
            style={{ animationDelay: "0.6s" }}
          />
          <div
            className="w-2 h-1 rounded-full bg-[#ff00ff]/50"
            style={{ animationDelay: "0.3s" }}
          />
