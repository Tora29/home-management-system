...
async function main() {
  ...
  const locations = [
    ...
    { name: 'kitchen_shelf', displayName: 'キッチン棚', description: 'キッチンの収納棚', sortOrder: 2 },
    ...
    { name: 'hallway_storage', displayName: '廊下収納', description: '廊下の収納スペース', sortOrder: 14 },
    ...
    { name: 'balcony', displayName: 'ベランダ', description: 'ベランダ・バルコニー', sortOrder: 19 },
